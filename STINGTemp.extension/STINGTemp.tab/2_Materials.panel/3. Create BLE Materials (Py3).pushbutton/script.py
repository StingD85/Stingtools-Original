...
output.close_others()
__title__ = "3. Create BLE\nMaterials (Py3)"
__author__ = "Author"
__doc__ = "Create BLE (building element) materials with appearance assets"

def main():
    doc = revit.doc
    output.print_md("# Create BLE Materials")
    all_mats = data_loader.load_ble_materials()
    ...
    with revit.Transaction("Create BLE Materials"):
        for md in all_mats:
