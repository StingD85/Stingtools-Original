# -*- coding: utf-8 -*-
"""Import Drafting Patterns from PAT file into Revit.

This script batch imports all patterns from a .pat file as DRAFTING patterns.
Use for cut/section patterns like hatches, material cuts, etc.
"""

__title__ = "Import\nDrafting\nPatterns"
__author__ = "BLE"
__doc__ = "Batch import DRAFTING fill patterns from .pat file"
...
# MAIN
pat_file = forms.pick_file(file_ext='pat', title='Select DRAFTING Patterns PAT File')

if pat_file:
    output.print_md("# Importing DRAFTING Patterns")
    ...
    existing_names = get_existing_pattern_names(doc, FillPatternTarget.Drafting)
    
    imported = 0
    skipped = 0
    errors = 0
    
    with revit.Transaction("Import Drafting Patterns"):
        for pattern_def in patterns:
            ...
            try:
                fill_pattern = create_fill_pattern(pattern_def, FillPatternTarget.Drafting)
    ...
    output.print_md("---")
    output.print_md("✅ **Complete!** Check Manage > Fill Patterns > Drafting tab")
else:
