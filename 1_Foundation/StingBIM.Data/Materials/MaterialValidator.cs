...
namespace StingBIM.Data.Materials
{
    ...
    public class MaterialValidator
    {
        ...
        public MaterialValidationResult ValidateElement(Element element)
        {
            ...
            try
            {
                ...
                // Get the material
                var material = _document.GetElement(materialId) as Autodesk.Revit.DB.Material;
                if (material == null)
                {
        ...
        public MaterialBatchValidationResult ValidateBatch(IEnumerable<Element> elements)
        {
            ...
            try
            {
                ...
                foreach (var element in elementList)
                {
                    ...
                    {
                        _logger.Warning($"Failed to validate element {element.Id}: {ex.Message}");
                        batchResult.InvalidCount++;
                    }
                }
    ...
    public class ValidationRule
    {
        ...
        public Func<Element, Autodesk.Revit.DB.Material, MaterialDatabase, ValidationRuleResult> Validate { get; set; }
    }
