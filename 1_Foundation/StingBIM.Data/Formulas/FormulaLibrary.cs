...
namespace StingBIM.Data.Formulas
{
    ...
    public class FormulaLibrary
    {
        ...
        private readonly Dictionary<string, LibraryFormulaDefinition> _formulasByName;
        private readonly Dictionary<string, List<LibraryFormulaDefinition>> _formulasByDiscipline;
        private readonly Dictionary<string, List<LibraryFormulaDefinition>> _formulasByParameter;
        private readonly List<LibraryFormulaDefinition> _allFormulas;
        ...
        /// </summary>
        public IReadOnlyList<LibraryFormulaDefinition> AllFormulas => _allFormulas.AsReadOnly();
        ...
        {
            _formulasByName = new Dictionary<string, LibraryFormulaDefinition>(StringComparer.OrdinalIgnoreCase);
            _formulasByDiscipline = new Dictionary<string, List<LibraryFormulaDefinition>>(StringComparer.OrdinalIgnoreCase);
            _formulasByParameter = new Dictionary<string, List<LibraryFormulaDefinition>>(StringComparer.OrdinalIgnoreCase);
            _allFormulas = new List<LibraryFormulaDefinition>();
            _isLoaded = false;
        }
        ...
        public LibraryFormulaDefinition GetByParameterName(string parameterName)
        {
        ...
        public List<LibraryFormulaDefinition> GetByDiscipline(string discipline)
        {
            if (string.IsNullOrWhiteSpace(discipline))
                return new List<LibraryFormulaDefinition>();

            lock (_lock)
            {
                return _formulasByDiscipline.TryGetValue(discipline, out var formulas)
                    ? new List<LibraryFormulaDefinition>(formulas)
                    : new List<LibraryFormulaDefinition>();
            }
        }
        ...
        public List<LibraryFormulaDefinition> GetByInputParameter(string inputParameter)
        {
        ...
        public List<LibraryFormulaDefinition> Filter(Func<LibraryFormulaDefinition, bool> predicate)
        {
            if (predicate == null)
        ...
        public List<LibraryFormulaDefinition> Search(string query, bool caseSensitive = false)
        {
        ...
        public List<LibraryFormulaDefinition> GetDependents(string parameterName)
        {
            if (string.IsNullOrWhiteSpace(parameterName))
                return new List<LibraryFormulaDefinition>();
        ...
        /// </summary>
        private List<LibraryFormulaDefinition> ParseCsvFile(string csvFilePath)
        {
            var formulas = new List<LibraryFormulaDefinition>();
            ...
            try
            {
                using (var reader = new StreamReader(csvFilePath))
                {
                    ...
                    while (!reader.EndOfStream)
                    {
                        ...
                        {
                            _logger.Warning($"Failed to parse line {lineNumber}: {ex.Message}");
                        }
                    }
                }
        ...
        /// </summary>
        private LibraryFormulaDefinition CreateFormulaFromCsvRow(List<string> values, Dictionary<string, int> columnMap)
        {
            try
            {
                var formula = new LibraryFormulaDefinition();
            ...
            {
                _logger.Warning($"Failed to create formula from CSV row: {ex.Message}");
                return null;
            }
        }
        ...
        /// </summary>
        private void AddFormula(LibraryFormulaDefinition formula)
        {
            if (formula == null)
                return;
            ...
            if (!string.IsNullOrWhiteSpace(formula.Discipline))
            {
                ...
                {
                    _formulasByDiscipline[formula.Discipline] = new List<LibraryFormulaDefinition>();
                }
            ...
            foreach (var inputParam in formula.InputParameters)
            {
                ...
                {
                    _formulasByParameter[inputParam] = new List<LibraryFormulaDefinition>();
                }
    ...
    /// </summary>
    public class LibraryFormulaDefinition
    {
        ...
        public LibraryFormulaDefinition()
        {
