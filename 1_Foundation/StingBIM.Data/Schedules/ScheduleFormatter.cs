    ...
    public class ScheduleFormatter
    {
        ...
        private void ApplyFieldFormatting(ViewSchedule schedule, ScheduleTemplate template)
        {
            try
            {
                ...
                for (int i = 0; i < fieldCount && i < template.Fields.Count; i++)
                {
                    ...
                    // Set alignment - Alignment is ScheduleHorizontalAlignment enum
        ...
        private ScheduleField FindFieldByName(ScheduleDefinition definition, string parameterName)
        {
            ...
            for (int i = 0; i < fieldCount; i++)
            {
                ...
                if (string.Equals(fieldName, parameterName, StringComparison.OrdinalIgnoreCase))
                {
                    return field;
                }
            }
        ...
        private Color ParseColor(string colorStr)
        {
            ...
            {
                _logger.Warn(ex, $"Failed to parse color: {colorStr}");
            }
        ...
        /// <summary>
        /// Parses alignment string to ScheduleHorizontalAlignment
        /// </summary>
        private ScheduleHorizontalAlignment ParseAlignment(string alignment)
        {
