...
namespace StingBIM.Data.Schedules
{
    ...
    public class FieldMapper
    {
        ...
        public SchedulableField MapParameterToField(string parameterName, ScheduleDefinition schedule)
        {
            ...
            try
            {
                ...
                {
                    var fieldName = field.GetName(_document);
                    if (fieldName.IndexOf(parameterName, StringComparison.OrdinalIgnoreCase) >= 0 ||
                        parameterName.IndexOf(fieldName, StringComparison.OrdinalIgnoreCase) >= 0)
                    {
        ...
        public void ConfigureField(ScheduleField field, ScheduleFieldDefinition fieldDef)
        {
            ...
            try
            {
                ...
                // Set alignment - fieldDef.Alignment is already ScheduleHorizontalAlignment
                field.HorizontalAlignment = fieldDef.Alignment;
                ...
                if (fieldDef.IsCalculated && !string.IsNullOrWhiteSpace(fieldDef.Formula))
                {
                ...
                using (var trans = new Transaction(_document, "Get Fields"))
                {
                    ...
                    foreach (var field in schedulableFields)
                    {
                        var fieldInfo = new FieldInfo
                        {
                            ...
                            // FieldId is only available after field is added to schedule
        ...
        /// <summary>
        /// Maps ScheduleFieldAlignment to Revit ScheduleHorizontalAlignment
        /// </summary>
        private ScheduleHorizontalAlignment MapAlignment(ScheduleFieldAlignment alignment)
        {
            switch (alignment)
            {
                case ScheduleFieldAlignment.Left:
                    return ScheduleHorizontalAlignment.Left;
                case ScheduleFieldAlignment.Center:
                    return ScheduleHorizontalAlignment.Center;
                case ScheduleFieldAlignment.Right:
        ...
        public ScheduleHorizontalAlignment GetRecommendedAlignment(string dataType)
        {
    ...
    /// <summary>
    /// Schedule field alignment options
    /// </summary>
