...
namespace StingBIM.Data.Parameters
{
    ...
    public class ParameterDefinition
    {
        ...
        /// <summary>
        /// Gets or sets the Revit StingBIMParameterType enumeration
        /// Converted from DataType string
        /// </summary>
        public StingBIMParameterType RevitStingBIMParameterType { get; set; }
        
        /// <summary>
        /// Gets or sets the categories this parameter is bound to
        /// </summary>
        public List<Category> BoundCategories { get; set; }
        ...
        {
            BoundCategories = new List<Category>();
            IsVisible = true;
        ...
        public static ParameterDefinition FromSharedParameterLine(string line, Dictionary<int, string> groups)
        {
            ...
            // Convert data type to Revit StingBIMParameterType
            param.RevitStingBIMParameterType = ConvertDataTypeToStingBIMParameterType(param.DataType);
        ...
        /// <summary>
        /// Converts data type string to Revit StingBIMParameterType
        /// </summary>
        private static StingBIMParameterType ConvertDataTypeToStingBIMParameterType(string dataType)
        {
        ...
        public ParameterDefinition Clone()
        {
            return new ParameterDefinition
            {
                ...
                RevitStingBIMParameterType = this.RevitStingBIMParameterType,
                BoundCategories = new List<Category>(this.BoundCategories),
    ...
    /// <summary>
    /// Parameter type enumeration (replaces deprecated Revit ParameterType)
    /// </summary>
    ...
    /// <summary>
    /// Helper class for converting parameter types to Revit API types
    /// </summary>
    public static class ParameterTypeConverter
    {
        /// <summary>
        /// Converts StingBIMParameterType to Revit ForgeTypeId
        /// </summary>
        public static Autodesk.Revit.DB.ForgeTypeId ToForgeTypeId(StingBIMParameterType paramType)
        {
            switch (paramType)
            {
                case StingBIMParameterType.Text:
                    return Autodesk.Revit.DB.SpecTypeId.String.Text;
                case StingBIMParameterType.Integer:
                    return Autodesk.Revit.DB.SpecTypeId.Int.Integer;
                case StingBIMParameterType.Number:
                    return Autodesk.Revit.DB.SpecTypeId.Number;
                case StingBIMParameterType.Length:
                    return Autodesk.Revit.DB.SpecTypeId.Length;
                case StingBIMParameterType.Area:
                    return Autodesk.Revit.DB.SpecTypeId.Area;
                case StingBIMParameterType.Volume:
                    return Autodesk.Revit.DB.SpecTypeId.Volume;
                case StingBIMParameterType.Angle:
                    return Autodesk.Revit.DB.SpecTypeId.Angle;
                case StingBIMParameterType.URL:
                    return Autodesk.Revit.DB.SpecTypeId.String.Url;
                case StingBIMParameterType.YesNo:
                    return Autodesk.Revit.DB.SpecTypeId.Boolean.YesNo;
                case StingBIMParameterType.Currency:
                    return Autodesk.Revit.DB.SpecTypeId.Currency;
                case StingBIMParameterType.ElectricalCurrent:
                    return Autodesk.Revit.DB.SpecTypeId.Current;
                case StingBIMParameterType.ElectricalPotential:
                    return Autodesk.Revit.DB.SpecTypeId.ElectricalPotential;
                case StingBIMParameterType.ElectricalPower:
                    return Autodesk.Revit.DB.SpecTypeId.HvacPower;
                case StingBIMParameterType.Material:
                    return Autodesk.Revit.DB.SpecTypeId.Reference.Material;
                case StingBIMParameterType.Image:
                    return Autodesk.Revit.DB.SpecTypeId.Reference.Image;
                case StingBIMParameterType.MultilineText:
                    return Autodesk.Revit.DB.SpecTypeId.String.MultilineText;
                default:
                    return Autodesk.Revit.DB.SpecTypeId.String.Text;
            }
        }
